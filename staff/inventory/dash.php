 ...
 <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <!--     <li>
                        ...
                        <li>
                             <a href="<?php echo web_root; ?>staff/products/index.php"> Damaged Items </a>
           
                        </li>
						<li>
                            <a href="<?php echo web_root; ?>staff/restock/index.php" > Replenishments </a>
                        ...
                        <li>
                         ...
                         <li>
                             <a href="<?php echo web_root; ?>staff/inventory/low/list.php" > Low Stocks </a>
