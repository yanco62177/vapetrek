...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> 09611022080</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> BEJOCADRIAN@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/logo.jpg" alt="" width="200" height="80"/></a>
            </div> 
          </div>
              ...
              <ul class="nav navbar-nav collapse navbar-collapse">
                ...
                <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                       <?php 
                                            $mydb->setQuery("SELECT * FROM `shop`");
                                            $cur = $mydb->loadResultList();
                                           foreach ($cur as $result) { 
                                       echo '<li><a href="index.php?q=product&shop='.$result->shop_id.'" >'.$result->shop_name.'</a></li>';
                                        } ?> 
                                    </ul>
                                </li> 
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>VAPE</span>TREK</h2>
              <p>YOUR LOCAL VAPESHOP ONLINE STORE</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">CREATED BY <span><a href="#">GROUP13</a></span></p>
          <p class="pull-right">DESIGNED BY <span><a target="_blank" href="#">GROUP13</a></span></p>
        </div>
      </div>
    </div>
