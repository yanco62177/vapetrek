        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" >VAPETREK</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        ?>
                         <li><a href="<?php echo web_root; ?>admin/user/index.php?view=add"><i class="fa fa-user  fa-fw"></i> User</a>
							...
							<li><a href="<?php echo web_root; ?>admin/owner/index.php?view=add"><i class="fa fa-user  fa-fw"></i> Owner</a>
                            </li>
							<li><a href="<?php echo web_root; ?>admin/staff/index.php?view=add"><i class="fa fa-user  fa-fw"></i> Staff</a>
                            </li>
							<li><a href="<?php echo web_root; ?>admin/shop/index.php?view=add"><i class="fa fa-shopping-bag  fa-fw"></i> Shop</a>
                            </li>
                        <?php }?>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <!--     <li>
						...
						<li>
                            <a href="<?php echo web_root; ?>admin/restock/index.php" ><i class="fa  fa-file-text fa-fw"></i> Restock </a>
                        ...
                        ?>
                         <li>
                             <a href="<?php echo web_root; ?>admin/settings/index.php" ><i class="fa fa-gear fa-spin"></i>  Setting </a>
                       ...
                       <!--   <li>
                          ...
                          <li>
                            <a href="<?php echo web_root; ?>admin/user/index.php" ><i class="fa fa-user fa-fw"></i> Admin Accounts </a>
						 ...
						 <li>
                            <a href="<?php echo web_root; ?>admin/shop/index.php" ><i class="fa  fa-shopping-bag fa-fw"></i> Shops </a>
                          
                        </li>
						<li>
                            <a href="<?php echo web_root; ?>admin/owner/index.php" ><i class="fa fa-user fa-fw"></i> Owner Accounts </a>
                          
                        </li>
						<li>
                            <a href="<?php echo web_root; ?>admin/staff/index.php" ><i class="fa fa-user fa-fw"></i> Satff Accounts </a>
