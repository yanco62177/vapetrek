 ...
 <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <!--     <li>
                        ...
                        <li>
                             <a href="<?php echo web_root; ?>admin/products/index.php"> Damaged Items </a>
           
                        </li>
						<li>
                            <a href="<?php echo web_root; ?>admin/restock/index.php" > Replenishments </a>
                          
                        </li>
                        <li>
                             <a href="<?php echo web_root; ?>admin/inventory/stocks/index.php" > Stocks Available </a>
                  </li>
                           
                         <li>
                             <a href="<?php echo web_root; ?>admin/inventory/low/index.php" > Low Stocks </a>
