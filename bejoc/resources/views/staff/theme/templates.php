...
?> 
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        Howdy, <?php echo $_SESSION['U_NAME']; ?> 
                    ...
                    <ul class="dropdown-menu dropdown-acnt">
                      ...
                      <div class="divtxt">
                        <li><a href="<?php echo web_root; ?>staff/user/index.php?view=edit&id=<?php echo $_SESSION['USERID']; ?>"> <?php echo $_SESSION['U_NAME']; ?> </a>
                      <li><a title="Edit" href="<?php echo web_root; ?>staff/user/index.php?view=edit&id=<?php echo $_SESSION['USERID']; ?>"  >Edit My Profile</a>
                                    
                        </li>
                          </li>
                           <li><a href="<?php echo web_root; ?>staff/logout.php"><i class="fa fa-sign-out fa-fw"></i> Log Out</a>
                        </li> 
                  </div>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <!--     <li>
                        ...
                        <li>
                             <a href="<?php echo web_root; ?>staff/products/index.php"><i class="fa fa-barcode fa-fw"></i>Products </a>
           
                        </li>
						<li>
                            <a href="<?php echo web_root; ?>staff/restock/index.php" ><i class="fa  fa-file-text fa-fw"></i> Restock </a>
                          
                        </li>
                        <li>
                             <a href="<?php echo web_root; ?>staff/orders/index.php" ><i class="fa fa-reorder fa-fw"></i>  Orders <?php echo $order; ?></a>
                  </li>
                         <li>
                             <a href="<?php echo web_root; ?>staff/settings/index.php" ><i class="fa fa-gear fa-spin"></i>  Setting </a>
                       ...
                       <!--   <li>
                         ...
                         <li>
                            <a href="<?php echo web_root; ?>staff/report/index.php" ><i class="fa  fa-file-text fa-fw"></i> Report </a>
